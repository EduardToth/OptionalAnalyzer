...
import compilationUnits.groups.UncategorizedIsPresentInvocationBasedAntipatternBuilder;
import compilationUnits.groups.Rule13AntipatternBuilder;
...
import FullAnalysis.groups.FullAnalysisGroupBuilder;
...
public class MCompilationUnitImpl implements MCompilationUnit {
	...
	private static final FullAnalysisGroupBuilder FullAnalysisGroupBuilder_INSTANCE = new FullAnalysisGroupBuilder();
	...
	@Override
	@ro.lrg.xcore.metametamodel.ThisIsARelationBuilder
	public ro.lrg.xcore.metametamodel.Group<MAnalysis> fullAnalysisGroupBuilder() {
		return FullAnalysisGroupBuilder_INSTANCE.buildGroup(this);
	}
