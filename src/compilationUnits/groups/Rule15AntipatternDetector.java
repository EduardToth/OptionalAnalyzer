...
@RelationBuilder
public class Rule15AntipatternDetector  implements IRelationBuilder<MRule15Atom, MCompilationUnit>{

	@Override
	public Group<MRule15Atom> buildGroup(MCompilationUnit arg0) {

		ICompilationUnit iCompilationUnit = (ICompilationUnit) arg0.getUnderlyingObject();
		Rule15AntipatternFinder rule15AtomFinder = new Rule15AntipatternFinder();
