...
@RelationBuilder
public class Rule21AntipatternDetector implements IRelationBuilder<MRule21Atom, MCompilationUnit>{

	@Override
	public Group<MRule21Atom> buildGroup(MCompilationUnit arg0) {
		Rule21AntipatternFinder rule21AtomFinder = new Rule21AntipatternFinder();
