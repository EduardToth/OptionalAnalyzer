...
import rule18Antipattern.Rule18AtomFinder;
import utilities.UtilityClass;


@RelationBuilder
public class Rule18AntipatternBuilder  implements IRelationBuilder<MRule18Atom, MCompilationUnit>{

	@Override
	public Group<MRule18Atom> buildGroup(MCompilationUnit arg0) {
		ICompilationUnit iCompilationUnit = (ICompilationUnit) arg0.getUnderlyingObject();
		Rule18AtomFinder rule18AtomFinder = new Rule18AtomFinder();
