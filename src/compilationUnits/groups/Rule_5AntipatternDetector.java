...
@RelationBuilder
public class Rule_5AntipatternDetector  implements IRelationBuilder<MRule5Atom, MCompilationUnit>{

	@Override
	public Group<MRule5Atom> buildGroup(MCompilationUnit arg0) {
		Rule5AntipatternFinder rule5AtomFinder = new Rule5AntipatternFinder();
