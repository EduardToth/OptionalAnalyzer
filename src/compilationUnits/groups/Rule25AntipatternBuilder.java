...
import rule25Antipattern.Rule25AtomFinder;
import utilities.UtilityClass;

@RelationBuilder
public class Rule25AntipatternBuilder implements IRelationBuilder<MRule25Atom, MCompilationUnit>{

	@Override
	public Group<MRule25Atom> buildGroup(MCompilationUnit arg0) {
		Rule25AtomFinder rule25AtomFinder = new Rule25AtomFinder();
