...
import rule19Antipattern.Rule19AtomFinder;
import utilities.UtilityClass;


@RelationBuilder
public class Rule19AntipatternBuilder  implements IRelationBuilder<MRule19Atom, MCompilationUnit>{

	@Override
	public Group<MRule19Atom> buildGroup(MCompilationUnit arg0) {
		ICompilationUnit iCompilationUnit = (ICompilationUnit) arg0.getUnderlyingObject();
		Rule19AtomFinder rule19AtomFinder = new Rule19AtomFinder();
