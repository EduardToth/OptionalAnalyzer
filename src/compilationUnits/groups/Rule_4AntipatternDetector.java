...
@RelationBuilder
public class Rule_4AntipatternDetector implements IRelationBuilder<MRule4Atom, MCompilationUnit>{

	@Override
	public Group<MRule4Atom> buildGroup(MCompilationUnit arg0) {
		Rule4AntipatternFinder rule4AtomFinder = new Rule4AntipatternFinder();
