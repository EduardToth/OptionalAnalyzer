...
@RelationBuilder
public class Rule_3AntipatternDetector  implements IRelationBuilder<MRule3Atom, MCompilationUnit>{

	@Override
	public Group<MRule3Atom> buildGroup(MCompilationUnit arg0) {
		Rule3AntipatternFinder rule3AtomFinder = new Rule3AntipatternFinder();
