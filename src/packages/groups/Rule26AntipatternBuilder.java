...
@RelationBuilder
public class Rule26AntipatternBuilder implements IRelationBuilder<MRule26Atom, MPackage>{

	@Override
	public Group<MRule26Atom> buildGroup(MPackage arg0) {
		Group<MRule26Atom> group = new Group<>();

		 List<MRule26Atom> atoms = arg0.compilationUnitBuilder()
				.getElements().stream()
				.map(MCompilationUnit::rule26AntipatternBuilder)
